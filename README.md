...
**Live URL (target):** [swap.traidedefi.com](https://swap.traidedefi.com)
...
- **Brand vehicle for TRAIDE.** Every quote query becomes a brand impression, even when TRAIDE does not win. Subdomain `swap.traidedefi.com` carries TRAIDE branding by URL alone.
...
```json
{
  ...
  "solana": "pending",
  "x402_tip_url": "https://swap.traidedefi.com/api/x402-tip",
...
4. Add custom domain `swap.traidedefi.com` via the Cloudflare Pages dashboard (the CNAME is auto-provisioned)
